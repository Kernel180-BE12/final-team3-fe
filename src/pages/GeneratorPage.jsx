          ...
          >
            <div
              className={`p-3 rounded-lg max-w-xs ${
                msg.type === "user" ? "bg-gray-200" : "bg-white border"
              }`}
            >
              {msg.type === "version" ? (
                <div>
        ...
        <header className="flex justify-end items-center p-4">
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-sm font-medium"
            >
              이 템플릿 승인하기
            </button>
          </div>
