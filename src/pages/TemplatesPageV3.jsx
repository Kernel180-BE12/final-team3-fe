  ...
  data: {
    items: [
      ...
      },
      {
        ...
        content: "안녕하세요, #{고객명}님.\n\n주문이 완료되었습니다.",
        status: "APPROVED",
        createdAt: "2025-09-17T15:21:43",
        buttons: [{ id: 20117, name: "자세히 보기" }],
        variables: [],
      },
      {
        id: 32043,
        userId: 103,
        title: "병원 예약 알림",
        content: "#{환자명}님, #{병원명} 예약일자 1일 전입니다.",
        status: "APPROVED",
      ...
      },
      {
        ...
        userId: 103,
        title: "배송 출발 안내",
        content: "#{고객명}님께서 주문하신 #{상품명}이(가) 발송되었습니다.",
        status: "REJECTED",
        createdAt: "2025-09-18T18:20:00",
        buttons: [],
        variables: [],
      },
      {
        ...
        userId: 103,
        title: "주말 이벤트 공지",
        content: "이번 주말, 특별 할인 이벤트를 진행합니다!",
        status: "APPROVE_REQUESTED",
      ...
      },
      {
        ...
        userId: 103,
        title: "비밀번호 초기화",
        content: "#{사이트명} 비밀번호가 초기화되었습니다.",
        status: "APPROVED",
        createdAt: "2025-09-19T09:05:00",
        buttons: [],
        variables: [],
      },
      {
        ...
        userId: 103,
        title: "구독 갱신 안내",
        content: "#{고객명}님의 구독이 만료될 예정입니다.",
        status: "REJECTED",
        createdAt: "2025-09-20T16:45:00",
        buttons: [],
        variables: [],
      },
      {
      ...
      },
      {
        ...
        title: "설문조사 참여 요청",
        content:
          "안녕하세요, #{고객명}님. 서비스 개선을 위해 잠시 시간을 내어주세요.",
        status: "APPROVED",
        createdAt: "2025-09-22T15:00:00",
        buttons: [],
        variables: [],
      },
    ],
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6">
            {!error && templates.length > 0 ? (
              templates.map((template) => (
                <div
                  key={template.id}
                  className="bg-white rounded-lg shadow-sm hover:shadow-lg flex flex-col border border-gray-200 transform transition duration-300 hover:-translate-y-1"
                >
                  <div className="p-4 border-b flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-1">
                        저장일: {template.createdAt.split("T")[0]}
                      </p>
                    </div>
                    <span
